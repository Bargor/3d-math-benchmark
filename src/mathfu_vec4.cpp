...
inline Vector<float, 4> compute_1(float a, float b)
{
...
inline Vector<float, 4> compute_2(float a, float b)
{
...
inline Vector<float, 4> compute_3(Vector<float, 4> a, Vector<float, 4> b)
{
    return a * b + a * b;
}
